...
// remember: no spaces in the JS below or add quotes
		...
		SOLI.lightsBox.innerHTML =
			...
			'<p>' +
				'<input type=checkbox id=inpLightAmbient onclick=SOLI.toggleLightAmbient(); checked /> Ambient Light <br>' +
			'</p>' +
			'<p>' +
	...
	SOLI.toggleLightPositionCamera = function() {
		if ( inpLightPositionCamera.checked === true ) {
			SOLI.lightCameraPosition = new THREE.PointLight( 0xffffff, 1 );
