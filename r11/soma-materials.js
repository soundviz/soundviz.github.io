...
//		texture.needsUpdate = true;
	...
	SOMA.Materials.PhongShiny = function() {
		...
		var material = new THREE.MeshPhongMaterial( { color: 0x550000, specular: 0x440000, envMap: reflectionCube, combine: THREE.MixOperation, reflectivity: 0.3, side: THREE.DoubleSide } );
		material.type = 3;
		return material;
	}
/*
