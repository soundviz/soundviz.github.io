	...
	JAMA.addMaterialSelectBox = function() {
		...
		tab.innerHTML =
			...
			'</p></a>';
		tabMaterialSelect.href = 'JavaScript:JA.toggleTab( JAMA.MaterialSelectBox ); ' ;
		...
		JAMA.MaterialSelectBox.innerHTML =
			...
			'<div>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongRandom(); >Phong Random (Default)</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.NormalSmooth(); >Normal Smooth</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.BasicFlatRed(); >Basic Flat Red</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.LambertSmoothRandom(); >Lambert Smooth Random</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongPlastic(); >Phong Plastic</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongFlat(); >Phong Flat</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongFlat2(); >Phong Flat2</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongSmooth(); >Phong Smooth</a><br>' +
			'</div>' +
//			'<h3 style=margin-bottom:0; >Materials - Vertex Colors</h3>' +
//				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongVertexColors(); >Phong Vertex Colors</a><br>' +

			'<h3 style=margin-bottom:0; >Materials - Textured</h3>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongGridded(); >Phong Gridded</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongUVGrid(); >Phong UVGrid</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongLavatile(); >Phong LaveTile</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongDisturb(); >Phong Disturb</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongCar(); >Phong Car</a><br>' +

			'<h3 style=margin-bottom:0; >Materials - Reflections</h3>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongChrome(); >Phong Chrome</a><br>' +
				'<a href=JavaScript:JATH.selectedObject.material=JAMA.materials.PhongShiny(); >Phong Shiny</a><br>' +
		'';
	};
	...
	JAMA.addMaterialEditorBox = function() {
		...
		tab.innerHTML =
			...
			'</p></a>';
		tabMaterialEditor.href = 'JavaScript:JA.toggleTab( JAMA.MaterialEditorBox );JAMA.updateMaterialEditorBox( JATH.selectedObject );' ;
...
// console.log( JATH.selectedObject.material, JATH.selectedObject.material.type );
		...
		inpOpacity.onchange = function() { m.opacity = this.value; JAMA.updateMaterialEditorBox(); };
